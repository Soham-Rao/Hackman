...
intents = json.loads(open(os.path.join("intents.json")).read())
...
p.dump(words, open(os.path.join( "main", "words.pkl"), "wb"))
p.dump(tags, open(os.path.join( "main", "tags.pkl"), "wb"))
...
model.save(os.path.join( "main", "chatbot_model.h5"), hist)
